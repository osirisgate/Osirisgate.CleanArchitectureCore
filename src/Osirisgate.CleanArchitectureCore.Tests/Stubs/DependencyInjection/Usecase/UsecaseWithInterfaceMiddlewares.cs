...
/// </remarks>
[Usecase(PreMiddlewares = new[] { typeof(IAuthenticationMiddleware), typeof(IAuthorizationMiddleware) })]
public sealed class UsecaseWithInterfaceMiddlewares : UsecaseBase
{
